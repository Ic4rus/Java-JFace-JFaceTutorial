package com.icarus.tutorial.jface.model;
...
public class DataModel {
	...
	public static List<Article> getArticles() {
		if (articleList == null) {
			...
			articleList.add(new Article("Hibernate for beginers", "Tran", true));
			articleList.add(new Article("Maven for beginers", "Smith", false));
		}
		return articleList;
	}
	...
	public static List<Department> getDepartments() {
		if (departmentList == null) {
			...
			empList2.add(emp21);
			Department dept2 = new Department("D02", "Administration", empList2);
	...
	public static List<AppMenu> getAppMenus() {
		if (appMenuList == null) {
			...
			AppMenu appMenu32 = new AppMenu("ProjectExplorer", "Project Explorer", null);
